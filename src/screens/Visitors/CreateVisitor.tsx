...
export const CreateVisitor = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response: VisitorResponse = await visitorService.createVisitor(formData);
      Toast.show({
        type: 'success',
        text1: 'Success',
      ...
      const errorMessage = error?.response?.data?.message || error?.message || 'Failed to create visitor';
      Toast.show({
        type: 'error',
        text1: 'Error',
        text2: errorMessage,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Create New Visitor</Text>
      </View>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={[styles.buttonText, styles.submitButtonText]}>Create Visitor</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
