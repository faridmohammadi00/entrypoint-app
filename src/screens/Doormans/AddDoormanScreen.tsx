...
export const AddDoormanScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const errorMessage = error?.response?.data?.message || error?.message || 'Failed to register doorman';
      Toast.show({
        type: 'error',
        text1: 'Error',
        text2: errorMessage,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Add New Doorman</Text>
      </View>
